...
const category = getCategory('pet-wellness')!;
const articles = getArticlesByCategory(category.slug);

const productPlaceholders =
  articles.find((article) => article.slug === 'smart-pet-tech-worth-the-money')?.productIdeas ?? [];
  ...
  <div class="page-shell">
    ...
    <section class="articles-section" aria-labelledby="articles-title">
      <div class="section-heading">
        ...
        <h2 id="articles-title">Pet tech that earns its place.</h2>
      </div>
      <p class="disclosure">
